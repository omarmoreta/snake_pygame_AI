...
class Agent:
    ...
    def __init__(self):
        ...
        self.memory = deque(maclen=MAX_MEMORY) # popleft()
        self.model = Linear_QNet(11, 256, 3) # values = 11, hidden layer = can play around with it, output =3
    ...
    def get_state(self, game):
        ...
        state = [
            ...
            # Food location
            game.food.x < game.head.x, # foor left
